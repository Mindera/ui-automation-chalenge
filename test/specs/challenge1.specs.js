...
describe('Mindera QA Graduate Challenge 1:',function() {
    ...
    describe('Mindera QA Graduate Challenge 1.2 :',function() {
        it('You must change the expect assertion in order to make the test can pass', function () {
    ...
    describe('Mindera QA Graduate Challenge 1.3 :',function() {
        it('You must define the selector in order to make the test can pass', function () {
